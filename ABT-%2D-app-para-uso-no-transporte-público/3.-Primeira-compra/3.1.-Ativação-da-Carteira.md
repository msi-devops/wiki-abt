Depois da primeira compra será preciso ativar a carteira virtual para que a geração do QRCODE seja iniciada e onde os valores comprados estarão armazenados. Essa ativação ocorrerá através do recebimento de um código por mensagem de texto no número que será informado. Portanto, certifique-se de que o número inserido seja real.
