...
Em seguida o cartão será cadastrado e estará apto para compras, ou você será redirecionado para a [tela de validação do cartão](/ABT-%2D-app-Android/4.-%2D-Cadastrando-um-cartão-de-Crédito/4.1-%2D-Validando-o-cartão-de-crédito-%2D-Ping-Value).