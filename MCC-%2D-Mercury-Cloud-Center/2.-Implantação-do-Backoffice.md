...
4. Passo.<BR><BR>- Deverão ser ajustando os arquivos abaixo. [Para maiores detalhes](/MCC-%2D-Mercury-Cloud-Center/2.-Implantação-do-Backoffice/2.1-%2D-Ajustando-as-configurações).
